...
function addOwnerTag(p2)
    ...
    TextLabel.Text = "Owner (https://discord.gg/3KjWyZ6uBu)"
...
t1[3] = t1[3](t1[2], {
	Name = "🩸 Bloody V2 🩸 crack",
	Icon = 0,
	LoadingTitle = "🩸 Bloody V2 🩸 crack",
	LoadingSubtitle = "by mopsech(discord)",
	ShowText = "test",
	Theme = t1[4],
	ToggleUIKeybind = "M",
...
notify("Bloody crack ez", "V2")

    -- [CRACK] by mopsech | https://discord.gg/3KjWyZ6uBu
